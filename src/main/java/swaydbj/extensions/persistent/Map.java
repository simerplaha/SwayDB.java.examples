 ...
 */
package swaydbj.extensions.persistent;
...
public class Map<K, V> implements Closeable {
    ...
    @SuppressWarnings("unchecked")
    public static <K, V> swaydbj.extensions.persistent.Map<K, V> create(Object keySerializer, Object valueSerializer,
            Path dir) {
        ...
        scala.concurrent.ExecutionContext ec = swaydb.persistent.Map$.MODULE$.apply$default$22(dir,
                ...
                bloomFilterFalsePositiveRate, compressDuplicateValues, deleteSegmentsEventually,
                lastLevelGroupingStrategy, acceleration);
        return new swaydbj.extensions.persistent.Map(
    ...
    public static class Builder<K, V> {
        ...
        @SuppressWarnings("unchecked")
        public swaydbj.extensions.persistent.Map<K, V> build() {
