...
public class QuickStartPersistentSetTest extends TestBase {
    ...
    public static void beforeClass() throws IOException {
        deleteDirectoryWalkTreeStartsWith("disk3");
    }
    ...
    public void persistentSetInt() {
        ...
        final swaydbj.persistent.Set<Integer> db = swaydbj.persistent.Set.create(
                Integer.class,
                Paths.get("disk3"));
        // db.add(1).get
        db.add(1);
    ...
    public void persistentSetIntIterator() {
        final swaydbj.persistent.Set<Integer> db = swaydbj.persistent.Set
                .<Integer>builder()
    ...
    public void persistentSetIntAddExpireAfter() {
        try (swaydbj.persistent.Set<Integer> db = swaydbj.persistent.Set
                        .<Integer>builder()
    ...
    public void memorySetIntRetainAll2() {
        try (swaydbj.persistent.Set<String> boxes = swaydbj.persistent.Set
                        .<String>builder()
