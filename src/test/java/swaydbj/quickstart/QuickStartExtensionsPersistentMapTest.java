...
public class QuickStartExtensionsPersistentMapTest extends TestBase {
    ...
    public void persistentMapIntStringFrom() {
        ...
        try (swaydbj.extensions.persistent.Map<Integer, String> db = swaydbj.extensions.persistent.Map.create(
    ...
    public void persistentMapIntStringClear() {
        ...
        try (swaydbj.extensions.persistent.Map<Integer, String> db = swaydbj.extensions.persistent.Map
    ...
    public void persistentMapIntStringMaps() {
        try (swaydbj.extensions.persistent.Map<String, String> rootMap = swaydbj.extensions.persistent.Map
