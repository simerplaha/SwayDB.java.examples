...
public class QuickStartMemorySetTest extends TestBase {
    ...
    public void memorySetInt() {
        ...
        final swaydbj.memory.Set<Integer> db = swaydbj.memory.Set.create(
                Integer.class);
        // db.add(1).get
        db.add(1);
        // db.get(1).get
    ...
    public void memorySetIntIterator() {
        final swaydbj.memory.Set<Integer> db = swaydbj.memory.Set
                .<Integer>builder()
    ...
    public void memorySetIntAddExpireAfter() {
        try (swaydbj.memory.Set<Integer> db = swaydbj.memory.Set
                        .<Integer>builder()
                        .withKeySerializer(Integer.class)
                        .build()) {
    ...
    public void memorySetIntRetainAll2() {
        try (swaydbj.memory.Set<String> boxes = swaydbj.memory.Set
                        .<String>builder()
