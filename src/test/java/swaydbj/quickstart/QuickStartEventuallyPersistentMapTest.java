...
public class QuickStartEventuallyPersistentMapTest extends TestBase {
    ...
    public void persistentMapIntStringFrom() {
        ...
        try (swaydbj.eventually.persistent.Map<Integer, String> db =
                swaydbj.eventually.persistent.Map.create(
    ...
    public void persistentMapIntStringMap() {
        try (swaydbj.eventually.persistent.Map<Integer, String> db = swaydbj.eventually.persistent.Map.create(
    ...
    public void persistentMapIntStringClear() {
        try (swaydbj.eventually.persistent.Map<Integer, String> db = swaydbj.eventually.persistent.Map
    ...
    public void persistentMapStringIntRegisterApplyFunctionUpdate() {
        try (swaydbj.eventually.persistent.Map<String, Integer> likesMap = swaydbj.eventually.persistent.Map
    ...
    public void persistentMapIntCustom() {
        ...
        try (swaydbj.eventually.persistent.Map<Integer, MyData> db = swaydbj.eventually.persistent.Map
