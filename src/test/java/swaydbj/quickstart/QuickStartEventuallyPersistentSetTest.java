...
public class QuickStartEventuallyPersistentSetTest extends TestBase {
    ...
    public void persistentSetInt() {
        ...
        final swaydbj.eventually.persistent.Set<Integer> db = swaydbj.eventually.persistent.Set.create(
                Integer.class,
                Paths.get("disk4"));
        // db.add(1).get
        db.add(1);
        ...
        db.commit(
                new swaydbj.java.Prepare<Integer, scala.runtime.Nothing$>().put(2, null),
    ...
    public void persistentSetIntIterator() {
        final swaydbj.eventually.persistent.Set<Integer> db = swaydbj.eventually.persistent.Set
                .<Integer>builder()
    ...
    public void persistentSetIntAddExpireAfter() {
        try (swaydbj.eventually.persistent.Set<Integer> db = swaydbj.eventually.persistent.Set
                        .<Integer>builder()
    ...
    public void memorySetIntRetainAll2() {
        try (swaydbj.eventually.persistent.Set<String> boxes = swaydbj.eventually.persistent.Set
                        .<String>builder()
